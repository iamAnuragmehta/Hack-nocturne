    ...
    <section id="about" className="flex flex-col p-8 md:p-12 min-h-screen">
      ...
      <div className="max-w-4xl mx-auto space-y-8 text-white">
        ...
        <div className="fade-animation text-center">
          ...
          <p className="fade-animation text-lg md:text-xl">
            Join us in{" "}
        ...
        {/* Track Section */}
        <div>
          <h2 className="fade-animation text-2xl md:text-3xl font-bold mb-4 text-purple-400">
            🎯 Track
          </h2>
          <div className="fade-animation p-6 border rounded-lg border-gray-500">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="fade-animation border border-gray-500 p-6 rounded-lg">
        ...
        <div className="text-center">
          ...
          <div className="fade-animation border border-gray-500 p-6 rounded-lg inline-block">
            <p className="text-xl">
              🗓️{" "}
        ...
        {/* Call to Action */}
        <div className="text-center space-y-4 hidden sm:">
          <h2 className="fade-animation text-2xl md:text-3xl font-bold text-purple-400">
            🚀 Ready to Hack?
          </h2>
          <p className="fade-animation text-lg">
            Follow us on our socials to stay updated. Gear up to code, create,
            and collaborate!
          </p>
          <p className="fade-animation text-xl font-bold text-purple-400">
            Let's make the night come alive with ideas and innovation! 🌌✨
          </p>
          <p className="fade-animation text-lg">Let the countdown begin! ⏳</p>
        </div>
